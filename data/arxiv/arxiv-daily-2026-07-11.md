...
## [1. Ideas Have Genomes: Benchmarking Scientific Lineage Reasoning and Lineage-Grounded Idea Generation](https://arxiv.org/abs/2607.08758v1)
...
**一句话总结**：Scientific ideas rarely start from a blank page. They inherit mechanisms, repair known limitations, and recombine pieces of earlier work, much like biological genomes. Current benchmarks still say lit...
...
**关键词**：Ideas, Have, Genomes, Benchmarking, Scientific, Lineage, Reasoning, Lineage-Grounded

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08758v1) | [下载PDF](https://arxiv.org/pdf/2607.08758v1.pdf)

---

## [2. Using AI-based Learning Assistants in Higher Education: A Large-Scale Descriptive Analysis](https://arxiv.org/abs/2607.08748v1)
...
**一句话总结**：In this study, we present a large-scale descriptive analysis of the use of an AI-based learning assistant (Syntea) in higher education. Based on objective log data from 77,543 students enrolled in dis...
...
**关键词**：AI-based, Learning, Assistants, Higher, Education, Large-Scale, Descriptive, Analysis

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08748v1) | [下载PDF](https://arxiv.org/pdf/2607.08748v1.pdf)

---

## [3. AUTOPILOT VQA: Benchmarking Vision-Language Models for Incident-Centric Dashcam Understanding](https://arxiv.org/abs/2607.08745v1)

**作者**：Siddharth Damodharan, Radhika Gupta, Ali Alshami 等 5 位作者  
**分类**：cs.AI, cs.CV  
**发布时间**：2026-07-09
...
**一句话总结**：Recent advances in Vision-Language Models, Large Language Models, and Multimodal Large Language Models have improved autonomous driving tasks such as scene understanding, decision making, trajectory p...
...
**关键词**：AUTOPILOT, VQA, Benchmarking, Vision-Language, Models, Incident-Centric, Dashcam, Understanding

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08745v1) | [下载PDF](https://arxiv.org/pdf/2607.08745v1.pdf)

---

## [4. Workflow as Knowledge: Semantic Persistence for LLM-Mediated Workflows](https://arxiv.org/abs/2607.08740v1)
...
**一句话总结**：Large language model (LLM) applications increasingly use explicit workflows for tool use, retrieval, branching, checkpointing, and human approval. Existing workflow systems already address many execut...
...
**关键词**：as, Workflow, Knowledge, Semantic, Persistence, LLM-Mediated, Workflows, Large

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08740v1) | [下载PDF](https://arxiv.org/pdf/2607.08740v1.pdf)

---

## [5. The Illusion of Equivalency: Statistical Characterization of Quantization Effects in LLMs](https://arxiv.org/abs/2607.08734v1)
...
**一句话总结**：Post-training quantization is widely used to deploy large language models in resource-constrained settings, yet its evaluation relies almost exclusively on accuracy and perplexity. We show that these ...
...
**关键词**：of, LLM, Illusion, Equivalency, Statistical, Characterization, Quantization, Effects

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08734v1) | [下载PDF](https://arxiv.org/pdf/2607.08734v1.pdf)
...
**一句话总结**：As agentic AI systems are increasingly applied to cyber-physical environments, their evaluation requires assessment of both task performance and trustworthiness. In decentralized energy markets, auton...
...
**关键词**：Agent, SolarChain-Eval, Physics-Constrained, Benchmark, Trustworthy, Economic, Decentralized, Energy

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08681v1) | [下载PDF](https://arxiv.org/pdf/2607.08681v1.pdf)

---

## [7. Formal Mechanisms for Market Stability in Self-Interested Agent Societies: A Marketplace Simulation Study](https://arxiv.org/abs/2607.08652v1)
...
**一句话总结**：Self-interested agents, left unconstrained, tend toward defection in repeated social dilemmas, causing cooperative gains from trade to collapse. This paper investigates what formal mechanisms, layered...
...
**关键词**：Agent, Formal, Mechanisms, Market, Stability, Self-Interested, Societies, Marketplace

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08652v1) | [下载PDF](https://arxiv.org/pdf/2607.08652v1.pdf)
...
**一句话总结**：The rapid development of large language models and multimodal large language models has accelerated the emergence of proactive agents capable of operating everyday tools and assisting users in real-wo...
...
**关键词**：Agent, UniClawBench, Universal, Benchmark, Proactive, Real-World, Tasks, rapid

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08768v1) | [下载PDF](https://arxiv.org/pdf/2607.08768v1.pdf)

---

## [9. Validity of LLMs as data annotators: AMALIA on authority](https://arxiv.org/abs/2607.08731v1)
...
**一句话总结**：A national language model offers a linguistic community its own instrument for measuring what its citizens say and value. Portugal's AMALIA, a publicly funded 9B-parameter model for European Portugues...
...
**关键词**：of, LLM, as, Validity, data, annotators, AMALIA, authority

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08731v1) | [下载PDF](https://arxiv.org/pdf/2607.08731v1.pdf)

---

## [10. Do You Need a Frontier Model as a Citation Verifier? Benchmarking Rubric LLMs for Deep-Research Source Attribution](https://arxiv.org/abs/2607.08700v1)

**作者**：Ethan Leung, Elias Lumer, Corey Feld 等 6 位作者  
**分类**：cs.CL  
**发布时间**：2026-07-09
...
**一句话总结**：Reinforcement learning increasingly relies on an LLM judge to score each rubric criterion, and that judge acts as the reward model during training. Before such a signal can be trusted, we need to know...
...
**关键词**：Do, as, Need, Frontier, Model, Citation, Verifier?, Benchmarking

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08700v1) | [下载PDF](https://arxiv.org/pdf/2607.08700v1.pdf)

---

## [11. WebSwarm: Recursive Multi-Agent Orchestration for Deep-and-Wide Web Search](https://arxiv.org/abs/2607.08662v1)

**作者**：Xiaoshuai Song, Liancheng Zhang, Kangzhi Zhao 等 11 位作者  
...
**一句话总结**：Large language model (LLM)-based web search agents are transforming information seeking from simple factoid question answering into complex, deep-and-wide search and research-oriented tasks. A single ...
...
**关键词**：Multi-Agent, WebSwarm, Recursive, Orchestration, Deep-and-Wide, Web, Search, Large

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08662v1) | [下载PDF](https://arxiv.org/pdf/2607.08662v1.pdf)

---

## cs.CV

## [12. Wat3R: Underwater 3D Geometry Learning without Annotations](https://arxiv.org/abs/2607.08772v1)

**作者**：Jiangwei Ren, Xingyu Jiang, Zijie Song 等 7 位作者  
**分类**：cs.CV  
**发布时间**：2026-07-09
...
**一句话总结**：Estimating 3D geometry in underwater environments presents unique challenges due to light attenuation, scattering, and the absence of large-scale, high-quality 3D annotations. Pioneering methods rely ...
...
**关键词**：3D, Wat3R, Underwater, Geometry, Learning, without, Annotations, Estimating

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08772v1) | [下载PDF](https://arxiv.org/pdf/2607.08772v1.pdf)

---

## [13. ZipDepth: Bringing Lightweight Zero-Shot Monocular Depth Anywhere, on Any Device](https://arxiv.org/abs/2607.08771v1)

**作者**：Fabio Tosi, Luca Bartolomei, Matteo Poggi 等 4 位作者  
**分类**：cs.CV  
**发布时间**：2026-07-09
...
**一句话总结**：Monocular depth estimation has seen remarkable progress through foundation models achieving robust zero-shot generalization, yet their computational demands place them far beyond the reach of embedded...
...
**关键词**：ZipDepth, Bringing, Lightweight, Zero-Shot, Monocular, Depth, Anywhere, Any

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08771v1) | [下载PDF](https://arxiv.org/pdf/2607.08771v1.pdf)

---

## [14. LongE2V: Long-Horizon Event-based Video Reconstruction, Prediction, and Frame Interpolation with Video Diffusion Models](https://arxiv.org/abs/2607.08770v1)
...
**一句话总结**：Recovering high-quality video from sparse event streams is a challenging task. Regression methods often blur textures, while existing generative models struggle with long-term stability. We propose Lo...
...
**关键词**：LongE2V, Long-Horizon, Event-based, Video, Reconstruction, Prediction, Frame, Interpolation

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08770v1) | [下载PDF](https://arxiv.org/pdf/2607.08770v1.pdf)

---

## [15. Geometry and Gradient-based Partitioning for Panoramic Outdoor Reconstruction](https://arxiv.org/abs/2607.08769v1)

**作者**：Weijian Chen, Weibo Yao, Yuhang Zhang 等 10 位作者  
**分类**：cs.CV  
**发布时间**：2026-07-09
...
**一句话总结**：Scaling 3D Gaussian Splatting (3DGS) to large outdoor scenes is costly in both data acquisition and computation. Adopting panoramic images with equirectangular projection (ERP) can reduce capture effo...
...
**关键词**：3D, Geometry, Gradient-based, Partitioning, Panoramic, Outdoor, Reconstruction, Scaling

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08769v1) | [下载PDF](https://arxiv.org/pdf/2607.08769v1.pdf)

---

## [16. OPSD-V: On-Policy Self-Distillation for Post-Training Few-Step Autoregressive Video Generators](https://arxiv.org/abs/2607.08766v1)
...
**一句话总结**：We propose OPSD-V, an on-policy self-distillation paradigm for post-training few-step autoregressive (AR) video diffusion models. Existing few-step AR video generators can produce long videos with low...
...
**关键词**：OPSD-V, On-Policy, Self-Distillation, Post-Training, Few-Step, Autoregressive, Video, Generators

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08766v1) | [下载PDF](https://arxiv.org/pdf/2607.08766v1.pdf)

---

## [17. WaspMOT: A Benchmark for Long-Term Multi-Object Tracking of Trichogramma Wasps](https://arxiv.org/abs/2607.08729v1)

**作者**：Tomasz Stanczyk, Yuan Gao, Hardik Agarwal 等 7 位作者  
**分类**：cs.CV  
**发布时间**：2026-07-09
...
**一句话总结**：Multi-object tracking (MOT) has achieved strong performance on benchmarks dominated by short video sequences. However, such datasets do not adequately evaluate long-term identity preservation, where o...
...
**关键词**：of, WaspMOT, Benchmark, Long-Term, Multi-Object, Tracking, Trichogramma, Wasps

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08729v1) | [下载PDF](https://arxiv.org/pdf/2607.08729v1.pdf)

---

## [18. Pose-to-Biomechanics: Bridging 3D Human Pose Estimation and Biomechanical Attribute Prediction](https://arxiv.org/abs/2607.08725v1)
...
**一句话总结**：Recent progress in 3D human pose estimation has made markerless recovery of skeletal motion increasingly accurate and scalable. However, most pose estimators remain optimized for geometric keypoint ac...
...
**关键词**：3D, Pose-to-Biomechanics, Bridging, Human, Pose, Estimation, Biomechanical, Attribute

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08725v1) | [下载PDF](https://arxiv.org/pdf/2607.08725v1.pdf)

---

## [19. LTM: Large-scale Terrain Model for Wildfire-prone Landscapes](https://arxiv.org/abs/2607.08711v1)

**作者**：Xiao Fu, Yue Hu, Meida Chen 等 5 位作者  
**分类**：cs.CV, cs.LG  
**发布时间**：2026-07-09
...
**一句话总结**：Accurate 3D terrain maps are essential for emergency response when assessing wildfire hazards. However, wildfire-prone regions often span vast areas where conventional reconstruction methods underperf...
...
**关键词**：3D, LTM, Large-scale, Terrain, Model, Wildfire-prone, Landscapes, Accurate

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08711v1) | [下载PDF](https://arxiv.org/pdf/2607.08711v1.pdf)

---

## [20. HumanForge: A Human-Centric Deepfake Video Benchmark with Multi-Agent Forgery Rationales](https://arxiv.org/abs/2607.08705v1)

**作者**：Wenbo Xu, Zhimin Chen, Xiaojie Liang 等 5 位作者  
**分类**：cs.CV  
**发布时间**：2026-07-09
...
**一句话总结**：Rapid advancements in video diffusion models and temporal editing tools have enabled the generation of highly realistic human-centric videos, posing unprecedented challenges to digital content forensi...
...
**关键词**：Multi-Agent, HumanForge, Human-Centric, Deepfake, Video, Benchmark, Forgery, Rationales

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08705v1) | [下载PDF](https://arxiv.org/pdf/2607.08705v1.pdf)

---

## [21. SAM-MT: Real-Time Interactive Multi-Target Video Segmentation](https://arxiv.org/abs/2607.08688v1)
...
**一句话总结**：Modern Video Object Segmentation (VOS) involves tracking and segmenting user-specified targets. While recent approaches have achieved remarkable performance in single-target scenarios, extending them ...
...
**关键词**：SAM-MT, Real-Time, Interactive, Multi-Target, Video, Segmentation, Modern, Object

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08688v1) | [下载PDF](https://arxiv.org/pdf/2607.08688v1.pdf)

---

## [22. Multi-Resolution Feature Stem for Diabetic Retinopathy lesion segmentation](https://arxiv.org/abs/2607.08679v1)
...
**一句话总结**：Diabetic Retinopathy (DR) is a leading cause of preventable blindness worldwide, requiring automated lesion segmentation using deep learning models for early detection and monitoring. However, DR lesi...
...
**关键词**：DR, Multi-Resolution, Feature, Stem, Diabetic, Retinopathy, lesion, segmentation

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08679v1) | [下载PDF](https://arxiv.org/pdf/2607.08679v1.pdf)

---

## [23. Do Transformations Reveal the Truth? Generative Residual Learning for Generalized AI-Generated Image Detection](https://arxiv.org/abs/2607.08674v1)

**作者**：Kutub Uddin, Nusrat Tasnim, Awais Khan 等 5 位作者  
**分类**：cs.CV  
**发布时间**：2026-07-09
...
**一句话总结**：The rapid advancement of generative AI has enabled the creation of highly realistic deepfake media, posing significant threats, including misinformation, digital identity theft, fraud, and manipulatio...
...
**关键词**：Do, Transformations, Reveal, Truth?, Generative, Residual, Learning, Generalized

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08674v1) | [下载PDF](https://arxiv.org/pdf/2607.08674v1.pdf)

---

## cs.LG

## [24. SLORR: Simple and Efficient In-Training Low-Rank Regularization](https://arxiv.org/abs/2607.08754v1)
...
**一句话总结**：Low-rank factorization is widely used to compress neural networks, but modern models are often not naturally amenable to aggressive factorization without significant accuracy loss. Existing training-t...
...
**关键词**：SLORR, Simple, Efficient, In-Training, Low-Rank, Regularization, factorization, widely

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08754v1) | [下载PDF](https://arxiv.org/pdf/2607.08754v1.pdf)

---

## [25. Dimensionality Reduction Meets Network Science: Sensemaking on UMAP's kNN Graph](https://arxiv.org/abs/2607.08746v1)

**作者**：Duen Horng Chau, Donghao Ren, Fred Hohman 等 4 位作者  
...
**一句话总结**：While UMAP is widely used for exploring high-dimensional data, typical workflows focus on its lower-dimensional embedding, largely overlooking the rich k-nearest-neighbor (kNN) graph that UMAP constru...
...
**关键词**：Dimensionality, Reduction, Meets, Network, Science, Sensemaking, UMAP's, kNN

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08746v1) | [下载PDF](https://arxiv.org/pdf/2607.08746v1.pdf)

---

## [26. Deep Learning for Joint Narrowband Interference Cancellation and Soft Demodulation in OFDM Systems](https://arxiv.org/abs/2607.08717v1)
...
**一句话总结**：Narrowband interference (NBI) severely degrades orthogonal frequency-division multiplexing (OFDM) systems by corrupting subcarriers and rendering classical soft demodulation ineffective. Conventional ...
...
**关键词**：Deep, Learning, Joint, Narrowband, Interference, Cancellation, Soft, Demodulation

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08717v1) | [下载PDF](https://arxiv.org/pdf/2607.08717v1.pdf)

---

## [27. MPFlow: Learning Budgeted Max-Flow Optimization on the Lightning Network with Deep Graph Reinforcement Learning](https://arxiv.org/abs/2607.08703v1)

**作者**：Harrison Rush, Vincent Davis, Simone Antonelli 等 6 位作者  
**分类**：cs.LG  
**发布时间**：2026-07-09
...
**一句话总结**：We address liquidity placement in the Bitcoin Lightning Network (LN): given a fixed budget, which channels should a node open to maximize its routing capacity? We cast this as a budget-constrained com...
...
**关键词**：MPFlow, Learning, Budgeted, Max-Flow, Optimization, Lightning, Network, Deep

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08703v1) | [下载PDF](https://arxiv.org/pdf/2607.08703v1.pdf)

---

## [28. Resample or Reroute? Budget-Aware Test-Time Model Selection for Large Language Models](https://arxiv.org/abs/2607.08665v1)
...
**一句话总结**：Routing among large language models (LLMs) trades response quality against serving cost, motivated by the reported gap between deployed routers and a per-instance oracle. Recent analysis shows that te...
...
**关键词**：or, Resample, Reroute?, Budget-Aware, Test-Time, Model, Selection, Large

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08665v1) | [下载PDF](https://arxiv.org/pdf/2607.08665v1.pdf)

---

## [29. EdgeRefine: Privacy-Utility Balance for Graphs via Jaccard Sampling under Edge Differential Privacy](https://arxiv.org/abs/2607.08659v1)

**作者**：Wenxiu Ding, Muzhi Liu, Zheng Yan 等 6 位作者  
**分类**：cs.LG  
**发布时间**：2026-07-09
...
**一句话总结**：Graph Neural Networks (GNNs) have shown considerable success in learning from graph-structured data, but their use in privacy-sensitive areas remains difficult because graph structure can leak sensiti...
...
**关键词**：EdgeRefine, Privacy-Utility, Balance, Graphs, via, Jaccard, Sampling, under

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08659v1) | [下载PDF](https://arxiv.org/pdf/2607.08659v1.pdf)

---

## [30. Multi-Modal, Multi-Environment Machine Teaching for Robust Reward Learning](https://arxiv.org/abs/2607.08647v1)

**作者**：Ali Larian, Qian Lin, Chang Zong Wu 等 4 位作者  
**分类**：cs.LG, cs.AI  
**发布时间**：2026-07-09
...
**一句话总结**：As autonomous agents are increasingly deployed across diverse operational contexts, aligning their behavior with human intent demands reward functions that remain robust to such changes rather than ov...
...
**关键词**：As, Multi-Modal, Multi-Environment, Machine, Teaching, Robust, Reward, Learning

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2607.08647v1) | [下载PDF](https://arxiv.org/pdf/2607.08647v1.pdf)
