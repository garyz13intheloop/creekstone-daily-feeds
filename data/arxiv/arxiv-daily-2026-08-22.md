...
**作者**：Narges Ahmadi, Yubo Jiao, Jônatas Augusto Manzolli 等 5 位作者  
**分类**：cs.AI, cs.CL  
**发布时间**：2026-08-20
...
**一句话总结**：Travel behavior research increasingly combines digital data collection with predictive modeling, yet these stages are often developed and evaluated separately. This study proposes a three-agent workfl...
...
**关键词**：An, Agentic, Approach, Active, Data, Collection, Travel, Behavior

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20320v1) | [下载PDF](https://arxiv.org/pdf/2608.20320v1.pdf)
...
**作者**：Yizhe Chi, Wenyi Li, Deyao Hong 等 10 位作者  
...
**一句话总结**：Recursive self-improvement (RSI) asks whether an AI system can improve the process that produces AI systems, so that the next system inherits the improvement. That process is the training algorithm: a...
...
**关键词**：LLM, Agent, AI4AI-Bench, Benchmarking, Algorithmic, Design, Recursive, Self-Improvement

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20318v1) | [下载PDF](https://arxiv.org/pdf/2608.20318v1.pdf)

---

## [3. Pandora's AI Model Routing Box: Efficient Allocation with Costly Value Estimation](https://arxiv.org/abs/2608.20316v1)

**作者**：Adam Fisch, Shubhendu Trivedi, Fantine Huot 等 8 位作者  
**分类**：cs.AI  
**发布时间**：2026-08-20
...
**一句话总结**：Heterogeneous AI systems composed of multiple models, architectures, harnesses, or inference-time settings can improve quality and efficiency by routing queries to the specialist who can answer most e...
...
**关键词**：Pandora's, Model, Routing, Box, Efficient, Allocation, Costly, Value

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20316v1) | [下载PDF](https://arxiv.org/pdf/2608.20316v1.pdf)

---

## [4. MidTool: Mid-training Data Synthesis for Agentic Tool Use](https://arxiv.org/abs/2608.20314v1)

**作者**：Fengqing Jiang, Yite Wang, Boyi Liu 等 8 位作者  
**分类**：cs.AI  
**发布时间**：2026-08-20
...
**一句话总结**：Mid-training is increasingly recognized as a critical stage for shaping the capabilities of large language models. Recent work has shown that targeted mid-training can strengthen reasoning-intensive a...
...
**关键词**：MidTool, Mid-training, Data, Synthesis, Agentic, Tool, Use, increasingly

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20314v1) | [下载PDF](https://arxiv.org/pdf/2608.20314v1.pdf)

---

## [5. Phantom Gains: Auditing Self-Improvement Against a Measured Null](https://arxiv.org/abs/2608.20290v1)

**作者**：Cheng Xu, Nan Yan, Liming Chen 等 4 位作者  
**分类**：cs.AI, cs.CL  
**发布时间**：2026-08-20
...
**一句话总结**：Whether a language model has improved itself is increasingly judged not by mean accuracy but by which individual problems it gains and loses. Tracking these transitions means differencing two noisy es...
...
**关键词**：Phantom, Gains, Auditing, Self-Improvement, Against, Measured, Null, Whether

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20290v1) | [下载PDF](https://arxiv.org/pdf/2608.20290v1.pdf)

---

## [6. Break It Down, Pass It On: Cross-Task Skill Transfer in LLM Agents](https://arxiv.org/abs/2608.20274v1)

**作者**：Yiyang Feng, Biddut Sarker Bijoy, Niranjan Balasubramanian 等 4 位作者  
**分类**：cs.AI, cs.CL  
**发布时间**：2026-08-20
...
**一句话总结**：Large language model (LLM) agents can induce skills from completed tasks and reuse them later to grow more capable with experience. In practice, induced skills may transfer unreliably and can even har...
...
**关键词**：It, LLM, Break, Down, Pass, Cross-Task, Skill, Transfer

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20274v1) | [下载PDF](https://arxiv.org/pdf/2608.20274v1.pdf)

---

## [7. Rule-Compliant Visual Spatial Planning for Multimodal Large Language Models](https://arxiv.org/abs/2608.20237v1)

**作者**：Yu Chen, Ting Lei, Yaoyi Li 等 6 位作者  
**分类**：cs.AI  
**发布时间**：2026-08-20
...
**一句话总结**：Multimodal large language models (MLLMs) combine linguistic reasoning with visual perception, yet their ability to perform visual spatial planning under explicit or previously unseen rule constraints ...
...
**关键词**：Rule-Compliant, Visual, Spatial, Planning, Multimodal, Large, Language, Models

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20237v1) | [下载PDF](https://arxiv.org/pdf/2608.20237v1.pdf)

---

## [8. InsufficiencyBench: Evaluating LLM legal advice on underspecified user queries](https://arxiv.org/abs/2608.20220v1)

**作者**：Samuel J. Vincent, Daniel Calloway, Fangyi Yu 等 5 位作者  
**分类**：cs.AI  
**发布时间**：2026-08-20
...
**一句话总结**：Legal AI systems are increasingly used to answer legal questions, yet existing benchmarks assume queries arrive fully specified. In practice, users omit facts that materially determine the legal outco...
...
**关键词**：LLM, InsufficiencyBench, Evaluating, legal, advice, underspecified, user, queries

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20220v1) | [下载PDF](https://arxiv.org/pdf/2608.20220v1.pdf)

---

## [9. Electronic Navigational Chart Change Classification](https://arxiv.org/abs/2608.20218v1)
...
**一句话总结**：Electronic Navigational Charts (ENCs) are geospatial vector datasets used in maritime navigation systems that represent hydrographic and navigational information such as depths, navigational aids, tra...
...
**关键词**：Electronic, Navigational, Chart, Change, Classification, Charts, ENCs, geospatial

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20218v1) | [下载PDF](https://arxiv.org/pdf/2608.20218v1.pdf)

---

## [10. ContractScrub: A benchmark for final review of legal contracts](https://arxiv.org/abs/2608.20204v1)

**作者**：Yejin Bang, Kirsty Fielding, Brandan Oliver 等 6 位作者  
**分类**：cs.AI, cs.CL  
**发布时间**：2026-08-20
...
**一句话总结**：Legal work, with its heavy reliance on processing large amounts of text, is often considered one of the domains most exposed to the use of LLMs. Contract ``scrubbing,'' the final review of transaction...
...
**关键词**：of, ContractScrub, benchmark, final, review, legal, contracts, work

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20204v1) | [下载PDF](https://arxiv.org/pdf/2608.20204v1.pdf)

---

## [11. MemTrapBench: Benchmarking Cognitive Traps in LLM Memory Use](https://arxiv.org/abs/2608.20202v1)
...
**一句话总结**：Memory has become a key component of large language models, enabling them to retain information and learn from long-term interactions. However, existing memory benchmarks mainly evaluate whether infor...
...
**关键词**：LLM, MemTrapBench, Benchmarking, Cognitive, Traps, Memory, Use, has

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20202v1) | [下载PDF](https://arxiv.org/pdf/2608.20202v1.pdf)

---

## [12. The Third Restructuring of Software Form: From the Three-Tier Architecture to Storage, Models, and Agents](https://arxiv.org/abs/2608.20201v1)

**作者**：Wei Lin, Tao Zhou, Zhaofei Xie 等 4 位作者  
**分类**：cs.AI, cs.SE  
**发布时间**：2026-08-20
...
**一句话总结**：Software form has undergone two paradigm shifts since its inception: Software 1.0, in which instructions determine behavior, and Software 2.0, in which data determines behavior (machine learning). Thi...
...
**关键词**：of, Third, Restructuring, Software, Form, Three-Tier, Architecture, Storage

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20201v1) | [下载PDF](https://arxiv.org/pdf/2608.20201v1.pdf)

---

## cs.CL

## [13. ConceptGuard: Benchmarking Context-Sensitive Unlearning in Large Language Models](https://arxiv.org/abs/2608.20338v1)
...
**一句话总结**：Large Language Models (LLMs) increasingly require selective removal of harmful or sensitive knowledge, called unlearning, yet existing methods and benchmarks fail to evaluate this capability completel...
...
**关键词**：LLM, ConceptGuard, Benchmarking, Context-Sensitive, Unlearning, Large, Language, Models

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20338v1) | [下载PDF](https://arxiv.org/pdf/2608.20338v1.pdf)

---

## [14. G-CARL: Grounded Checklist-Aligned Reward Learning for Patient-Oriented Medical Report Interpretation](https://arxiv.org/abs/2608.20331v1)

**作者**：Shiao Xie, Siyu Chen, Jianwei Lv 等 6 位作者  
...
**一句话总结**：Personalized interpretation of medical reports has emerged as an increasingly important need among patients. Addressing this need requires both evidence-grounded medical factuality and context-depende...
...
**关键词**：G-CARL, Grounded, Checklist-Aligned, Reward, Learning, Patient-Oriented, Medical, Report

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20331v1) | [下载PDF](https://arxiv.org/pdf/2608.20331v1.pdf)

---

## [15. Inducing Task Models from Computer-Use Traces](https://arxiv.org/abs/2608.20319v1)

**作者**：Yucheng Jiang, Zora Zhiruo Wang, Ruishi Chen 等 4 位作者  
**分类**：cs.CL, cs.AI  
**发布时间**：2026-08-20
...
**一句话总结**：Naturalistic computer-use traces, passively recorded screenshots and mouse or keyboard actions, are a valuable resource for deriving symbolic, auditable, and reusable models of how everyday work is do...
...
**关键词**：Inducing, Task, Models, Computer-Use, Traces, Naturalistic, passively, recorded

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20319v1) | [下载PDF](https://arxiv.org/pdf/2608.20319v1.pdf)

---

## [16. Inject, Align, Recover: Staged Post-Training for Retrieval-Free Document Knowledge Internalization](https://arxiv.org/abs/2608.20281v1)
...
**一句话总结**：Large language models often fail to answer questions about a bounded document collection when the source documents are not retrieved at inference time. We study this setting as document knowledge inte...
...
**关键词**：Inject, Align, Recover, Staged, Post-Training, Retrieval-Free, Document, Knowledge

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20281v1) | [下载PDF](https://arxiv.org/pdf/2608.20281v1.pdf)

---

## cs.CV

## [17. Swift-Image: Exploring the Performance Frontier of Compact Unified Image Generation Models](https://arxiv.org/abs/2608.20334v1)

**作者**：Taihang Hu, Zhao Wang, Zuan Gao 等 21 位作者  
**分类**：cs.CV  
**发布时间**：2026-08-20
...
**一句话总结**：We present Swift-Image, a compact unified model for text-to-image generation, single-image editing, and multi-image editing. Our goal is to explore how far a relatively small visual generator can be p...
...
**关键词**：of, Swift-Image, Exploring, Performance, Frontier, Compact, Unified, Image

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20334v1) | [下载PDF](https://arxiv.org/pdf/2608.20334v1.pdf)

---

## [18. Inter-X++: A Comprehensive Benchmark for Multimodal Human-Human Interaction Analysis](https://arxiv.org/abs/2608.20312v1)

**作者**：Liang Xu, Chengqun Yang, Zili Lin 等 9 位作者  
**分类**：cs.CV  
**发布时间**：2026-08-20
...
**一句话总结**：The capability to perceive and synthesize human-human interactions is fundamental to developing intelligent digital human systems. However, existing datasets and modeling approaches are fundamentally ...
...
**关键词**：Inter-X++, Comprehensive, Benchmark, Multimodal, Human-Human, Interaction, Analysis, capability

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20312v1) | [下载PDF](https://arxiv.org/pdf/2608.20312v1.pdf)

---

## [19. DreamHand: Repurposing Video Diffusion Models for Occlusion-Robust Egocentric 3D Hand Motion Recovery](https://arxiv.org/abs/2608.20308v1)

**作者**：Yufei Liu, Xixi Wang, Hao Li 等 11 位作者  
**分类**：cs.CV  
**发布时间**：2026-08-20
...
**一句话总结**：Egocentric video offers scalable manipulation data for embodied AI, yet recovering metric 3D hand trajectories remains challenging due to severe object occlusion and frequent out-of-sight gaps. Existi...
...
**关键词**：Diffusion, 3D, DreamHand, Repurposing, Video, Models, Occlusion-Robust, Egocentric

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20308v1) | [下载PDF](https://arxiv.org/pdf/2608.20308v1.pdf)

---

## [20. CalcSeg: Confidence-aware 3D Latent Context Curriculum Learning For Myocardial Scar Segmentation From Single-Stack LGE-CMRs](https://arxiv.org/abs/2608.20305v1)

**作者**：Nivetha Jayakumar, Hannah Kim, Amit R. Patel 等 4 位作者  
**分类**：cs.CV  
**发布时间**：2026-08-20
...
**一句话总结**：Myocardial scar segmentation from single-stack late gadolinium-enhanced cardiac magnetic resonance (LGE-CMR) imaging has been a longstanding and clinically important challenge, particularly in the pre...
...
**关键词**：3D, CalcSeg, Confidence-aware, Latent, Context, Curriculum, Learning, Myocardial

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20305v1) | [下载PDF](https://arxiv.org/pdf/2608.20305v1.pdf)

---

## [21. Towards Surgical World-Action Modeling: A Preliminary Joint Visual-Trajectory Forecasting for Surgical Motion Planning](https://arxiv.org/abs/2608.20284v1)

**作者**：Weiliang Huang, Huanrong Liu, Bob Zhang 等 8 位作者  
**分类**：cs.CV, cs.RO  
**发布时间**：2026-08-20
...
**一句话总结**：Reliable surgical planning requires models to anticipate not only how instruments will move, but also how the operative visual state will evolve together with such motion. Existing approaches typicall...
...
**关键词**：Towards, Surgical, World-Action, Modeling, Preliminary, Joint, Visual-Trajectory, Forecasting

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20284v1) | [下载PDF](https://arxiv.org/pdf/2608.20284v1.pdf)

---

## [22. Prompt-Conditioned Channel Attention for Hierarchical Feature Modulation toward Anatomy-Agnostic Segmentation](https://arxiv.org/abs/2608.20229v1)

**作者**：Mosharof Hossain, Md Rabiul Islam, Limon Halder 等 5 位作者  
**分类**：cs.CV, cs.AI  
**发布时间**：2026-08-20
...
**一句话总结**：Anatomically plausible segmentation remains challenging because of low contrast, ambiguous boundaries, and modality-specific artifacts. Interactive segmentation has emerged as a promising strategy to ...
...
**关键词**：Prompt-Conditioned, Channel, Attention, Hierarchical, Feature, Modulation, toward, Anatomy-Agnostic

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20229v1) | [下载PDF](https://arxiv.org/pdf/2608.20229v1.pdf)

---

## [23. Unwarping the Lens: A Physics-Grounded Approach to Video Glasses Removal](https://arxiv.org/abs/2608.20212v1)

**作者**：Radim Spetlik, David Futschik, Radek Danecek 等 7 位作者  
**分类**：cs.CV  
**发布时间**：2026-08-20
...
**一句话总结**：High-fidelity removal of eyeglasses from video is a major challenge in facial attribute editing, as the underlying facial geometry is often obscured by complex refractive distortions and view-dependen...
...
**关键词**：Unwarping, Lens, Physics-Grounded, Approach, Video, Glasses, Removal, High-fidelity

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20212v1) | [下载PDF](https://arxiv.org/pdf/2608.20212v1.pdf)

---

## [24. RoMAN-Flow: Taming Autoregressive Normalizing Flows for Offline Reinforcement Learning in Robotic Manipulation](https://arxiv.org/abs/2608.20208v1)

**作者**：Shaoxuan Wang, Guangting Zheng, Rui Huang 等 7 位作者  
**分类**：cs.CV  
**发布时间**：2026-08-20
...
**一句话总结**：Offline reinforcement learning improves robotic policies using previously collected data without further environment interaction. Yet prevalent diffusion- and flow-matching robot policies lack tractab...
...
**关键词**：RoMAN-Flow, Taming, Autoregressive, Normalizing, Flows, Offline, Reinforcement, Learning

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20208v1) | [下载PDF](https://arxiv.org/pdf/2608.20208v1.pdf)

---

## cs.LG

## [25. A comparison between ceiling-mounted FMCW, IR-UWB and Wi-Fi radar for in-bedroom human activity monitoring and sleep interruption detection](https://arxiv.org/abs/2608.20322v1)

**作者**：Anton Lambrecht, Reda El Hail, Xianjun Jiao 等 8 位作者  
**分类**：cs.LG  
**发布时间**：2026-08-20
...
**一句话总结**：Despite their growing importance for contact-free radio frequency (RF) based healthcare monitoring, different radio technologies such as frequency-modulated continuous wave (FMCW) radar, impulse radio...
...
**关键词**：comparison, between, ceiling-mounted, FMCW, IR-UWB, Wi-Fi, radar, in-bedroom

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20322v1) | [下载PDF](https://arxiv.org/pdf/2608.20322v1.pdf)

---

## [26. Physical-Support Confidence Sets for Highly Coherent Dictionaries](https://arxiv.org/abs/2608.20295v1)
...
**一句话总结**：Sparse pursuit after dictionary learning can yield a precise atom support even when its physical interpretation is not justified by the calibration data, especially for highly coherent dictionaries wh...
...
**关键词**：Physical-Support, Confidence, Sets, Highly, Coherent, Dictionaries, Sparse, pursuit

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20295v1) | [下载PDF](https://arxiv.org/pdf/2608.20295v1.pdf)

---

## [27. Dynamic Structural Causal Modeling for Sleep](https://arxiv.org/abs/2608.20285v1)

**作者**：Ranveer Singh, Saurabh Mathur, Pranuthi Tenali 等 5 位作者  
**分类**：cs.LG  
**发布时间**：2026-08-20
...
**一句话总结**：The causal dynamics of sleep-disordered breathing are complex and vary across patient populations, hindering the development of targeted interventions. We learn dynamic causal graphs of sleep-disorder...
...
**关键词**：of, Dynamic, Structural, Causal, Modeling, Sleep, dynamics, sleep-disordered

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20285v1) | [下载PDF](https://arxiv.org/pdf/2608.20285v1.pdf)

---

## [28. DICS: Data-Informed Centroid Splitting for Decision Tree Classifiers](https://arxiv.org/abs/2608.20258v1)
...
**一句话总结**：Decision tree-based models are widely used in machine learning due to their interpretability and strong empirical performance. However, training decision trees can be computationally expensive, partic...
...
**关键词**：DICS, Data-Informed, Centroid, Splitting, Decision, Tree, Classifiers, tree-based

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20258v1) | [下载PDF](https://arxiv.org/pdf/2608.20258v1.pdf)

---

## [29. Decoding silent reading from non-invasive EEG](https://arxiv.org/abs/2608.20186v1)
...
**一句话总结**：Non-invasive decoding of inner speech faces a fundamental data problem: a corpus pairing brain activity with a person's spontaneous inner monologue cannot be collected, and the available proxy paradig...
...
**关键词**：of, Decoding, silent, reading, non-invasive, EEG, inner, speech

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20186v1) | [下载PDF](https://arxiv.org/pdf/2608.20186v1.pdf)

---

## [30. Exact Algebraic Computation of Learning Coefficients for Two-Dimensional Singular Models](https://arxiv.org/abs/2608.20183v1)
...
**一句话总结**：Classical information criteria such as the Bayesian Information Criterion (BIC) rely on regularity assumptions that break down for singular models, leading to incorrect model selection in settings suc...
...
**关键词**：of, Exact, Algebraic, Computation, Learning, Coefficients, Two-Dimensional, Singular

**评分**：0

**论文链接**：[查看原文](https://arxiv.org/abs/2608.20183v1) | [下载PDF](https://arxiv.org/pdf/2608.20183v1.pdf)
